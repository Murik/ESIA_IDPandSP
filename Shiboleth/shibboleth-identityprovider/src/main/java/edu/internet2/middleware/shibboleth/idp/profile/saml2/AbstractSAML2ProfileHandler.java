...
//        }
    ...
    protected void writeAuditLogEntry(BaseSAMLProfileRequestContext context) {
        ...
        } else if (context.getSubjectNameIdentifier() != null && context.getSubjectNameIdentifier() instanceof NameID) {
            auditLogEntry.setNameIdValue(((NameID) context.getSubjectNameIdentifier()).getValue());
        }
