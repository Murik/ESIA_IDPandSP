...
public class SAML2SSOTestCase extends BaseConf1TestCase {
    ...
    public void testSecondAuthenticationLeg() throws Exception {
        ...
        // Add a fake session with a user identity to the request.
        SessionManager sessionManager = (SessionManager) getApplicationContext().getBean("shibboleth.SessionManager");
        ...
        servletRequest.setAttribute(Session.HTTP_SESSION_BINDING_ATTRIBUTE, idpSession);
